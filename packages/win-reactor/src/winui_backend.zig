...
/// TextBlock, TextBox, Canvas, ListView, and ItemsRepeater runtime objects,
/// with generated property/event dispatch wired for manifest-covered members
/// and manual fallbacks for the current attached-property / collection-
/// property gaps.
