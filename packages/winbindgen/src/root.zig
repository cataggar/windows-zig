...
pub fn emitNamespace(
    ...
    try emitIidConstants(writer, arena, file, namespace);
    try emitEnums(writer, arena, file, namespace);
    try emitStructs(writer, arena, file, namespace);
    try emitInterfaceHandles(writer, file, namespace);
    try emitRuntimeClasses(writer, file, namespace);
    try emitInterfaceVtbls(writer, arena, file, namespace);
}
