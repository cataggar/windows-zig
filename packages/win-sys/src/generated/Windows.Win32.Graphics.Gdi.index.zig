...
pub const aliases = struct {
    ...
    pub const FONTENUMPROCA = ?*const anyopaque;
    pub const FONTENUMPROCW = ?*const anyopaque;
    pub const GOBJENUMPROC = ?*const anyopaque;
    pub const LINEDDAPROC = ?*const anyopaque;
    pub const LPFNDEVMODE = ?*const anyopaque;
    pub const LPFNDEVCAPS = ?*const anyopaque;
    pub const MFENUMPROC = ?*const anyopaque;
    pub const ENHMFENUMPROC = ?*const anyopaque;
    pub const CFP_ALLOCPROC = ?*const anyopaque;
    pub const CFP_REALLOCPROC = ?*const anyopaque;
    pub const CFP_FREEPROC = ?*const anyopaque;
    pub const READEMBEDPROC = ?*const anyopaque;
    pub const WRITEEMBEDPROC = ?*const anyopaque;
    pub const GRAYSTRINGPROC = ?*const anyopaque;
    pub const DRAWSTATEPROC = ?*const anyopaque;
    pub const MONITORENUMPROC = ?*const anyopaque;
};
