...
pub const aliases = struct {
    ...
    pub const PFNFCIALLOC = ?*const anyopaque;
    pub const PFNFCIFREE = ?*const anyopaque;
    pub const PFNFCIOPEN = ?*const anyopaque;
    pub const PFNFCIREAD = ?*const anyopaque;
    pub const PFNFCIWRITE = ?*const anyopaque;
    pub const PFNFCICLOSE = ?*const anyopaque;
    pub const PFNFCISEEK = ?*const anyopaque;
    pub const PFNFCIDELETE = ?*const anyopaque;
    pub const PFNFCIGETNEXTCABINET = ?*const anyopaque;
    pub const PFNFCIFILEPLACED = ?*const anyopaque;
    pub const PFNFCIGETOPENINFO = ?*const anyopaque;
    pub const PFNFCISTATUS = ?*const anyopaque;
    pub const PFNFCIGETTEMPFILE = ?*const anyopaque;
    pub const PFNALLOC = ?*const anyopaque;
    pub const PFNFREE = ?*const anyopaque;
    pub const PFNOPEN = ?*const anyopaque;
    pub const PFNREAD = ?*const anyopaque;
    pub const PFNWRITE = ?*const anyopaque;
    pub const PFNCLOSE = ?*const anyopaque;
    pub const PFNSEEK = ?*const anyopaque;
    pub const PFNFDIDECRYPT = ?*const anyopaque;
    pub const PFNFDINOTIFY = ?*const anyopaque;
};
