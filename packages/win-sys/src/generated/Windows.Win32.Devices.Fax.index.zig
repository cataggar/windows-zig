...
pub const aliases = struct {
    ...
    pub const PFAXCONNECTFAXSERVERA = ?*const anyopaque;
    pub const PFAXCONNECTFAXSERVERW = ?*const anyopaque;
    pub const PFAXCLOSE = ?*const anyopaque;
    pub const PFAXOPENPORT = ?*const anyopaque;
    pub const PFAXCOMPLETEJOBPARAMSA = ?*const anyopaque;
    pub const PFAXCOMPLETEJOBPARAMSW = ?*const anyopaque;
    pub const PFAXSENDDOCUMENTA = ?*const anyopaque;
    pub const PFAXSENDDOCUMENTW = ?*const anyopaque;
    pub const PFAX_RECIPIENT_CALLBACKA = ?*const anyopaque;
    pub const PFAX_RECIPIENT_CALLBACKW = ?*const anyopaque;
    pub const PFAXSENDDOCUMENTFORBROADCASTA = ?*const anyopaque;
    pub const PFAXSENDDOCUMENTFORBROADCASTW = ?*const anyopaque;
    pub const PFAXENUMJOBSA = ?*const anyopaque;
    pub const PFAXENUMJOBSW = ?*const anyopaque;
    pub const PFAXGETJOBA = ?*const anyopaque;
    pub const PFAXGETJOBW = ?*const anyopaque;
    pub const PFAXSETJOBA = ?*const anyopaque;
    pub const PFAXSETJOBW = ?*const anyopaque;
    pub const PFAXGETPAGEDATA = ?*const anyopaque;
    pub const PFAXGETDEVICESTATUSA = ?*const anyopaque;
    pub const PFAXGETDEVICESTATUSW = ?*const anyopaque;
    pub const PFAXABORT = ?*const anyopaque;
    pub const PFAXGETCONFIGURATIONA = ?*const anyopaque;
    pub const PFAXGETCONFIGURATIONW = ?*const anyopaque;
    pub const PFAXSETCONFIGURATIONA = ?*const anyopaque;
    pub const PFAXSETCONFIGURATIONW = ?*const anyopaque;
    pub const PFAXGETLOGGINGCATEGORIESA = ?*const anyopaque;
    pub const PFAXGETLOGGINGCATEGORIESW = ?*const anyopaque;
    pub const PFAXSETLOGGINGCATEGORIESA = ?*const anyopaque;
    pub const PFAXSETLOGGINGCATEGORIESW = ?*const anyopaque;
    pub const PFAXENUMPORTSA = ?*const anyopaque;
    pub const PFAXENUMPORTSW = ?*const anyopaque;
    pub const PFAXGETPORTA = ?*const anyopaque;
    pub const PFAXGETPORTW = ?*const anyopaque;
    pub const PFAXSETPORTA = ?*const anyopaque;
    pub const PFAXSETPORTW = ?*const anyopaque;
    pub const PFAXENUMROUTINGMETHODSA = ?*const anyopaque;
    pub const PFAXENUMROUTINGMETHODSW = ?*const anyopaque;
    pub const PFAXENABLEROUTINGMETHODA = ?*const anyopaque;
    pub const PFAXENABLEROUTINGMETHODW = ?*const anyopaque;
    pub const PFAXENUMGLOBALROUTINGINFOA = ?*const anyopaque;
    pub const PFAXENUMGLOBALROUTINGINFOW = ?*const anyopaque;
    pub const PFAXSETGLOBALROUTINGINFOA = ?*const anyopaque;
    pub const PFAXSETGLOBALROUTINGINFOW = ?*const anyopaque;
    pub const PFAXGETROUTINGINFOA = ?*const anyopaque;
    pub const PFAXGETROUTINGINFOW = ?*const anyopaque;
    pub const PFAXSETROUTINGINFOA = ?*const anyopaque;
    pub const PFAXSETROUTINGINFOW = ?*const anyopaque;
    pub const PFAXINITIALIZEEVENTQUEUE = ?*const anyopaque;
    pub const PFAXFREEBUFFER = ?*const anyopaque;
    pub const PFAXSTARTPRINTJOBA = ?*const anyopaque;
    pub const PFAXSTARTPRINTJOBW = ?*const anyopaque;
    pub const PFAXPRINTCOVERPAGEA = ?*const anyopaque;
    pub const PFAXPRINTCOVERPAGEW = ?*const anyopaque;
    pub const PFAXREGISTERSERVICEPROVIDERW = ?*const anyopaque;
    pub const PFAXUNREGISTERSERVICEPROVIDERW = ?*const anyopaque;
    pub const PFAX_ROUTING_INSTALLATION_CALLBACKW = ?*const anyopaque;
    pub const PFAXREGISTERROUTINGEXTENSIONW = ?*const anyopaque;
    pub const PFAXACCESSCHECK = ?*const anyopaque;
    pub const PFAX_SERVICE_CALLBACK = ?*const anyopaque;
    pub const PFAX_LINECALLBACK = ?*const anyopaque;
    pub const PFAX_SEND_CALLBACK = ?*const anyopaque;
    pub const PFAXDEVINITIALIZE = ?*const anyopaque;
    pub const PFAXDEVVIRTUALDEVICECREATION = ?*const anyopaque;
    pub const PFAXDEVSTARTJOB = ?*const anyopaque;
    pub const PFAXDEVENDJOB = ?*const anyopaque;
    pub const PFAXDEVSEND = ?*const anyopaque;
    pub const PFAXDEVRECEIVE = ?*const anyopaque;
    pub const PFAXDEVREPORTSTATUS = ?*const anyopaque;
    pub const PFAXDEVABORTOPERATION = ?*const anyopaque;
    pub const PFAXDEVCONFIGURE = ?*const anyopaque;
    pub const PFAXDEVSHUTDOWN = ?*const anyopaque;
    pub const PFAXROUTEADDFILE = ?*const anyopaque;
    pub const PFAXROUTEDELETEFILE = ?*const anyopaque;
    pub const PFAXROUTEGETFILE = ?*const anyopaque;
    pub const PFAXROUTEENUMFILE = ?*const anyopaque;
    pub const PFAXROUTEENUMFILES = ?*const anyopaque;
    pub const PFAXROUTEMODIFYROUTINGDATA = ?*const anyopaque;
    pub const PFAXROUTEINITIALIZE = ?*const anyopaque;
    pub const PFAXROUTEMETHOD = ?*const anyopaque;
    pub const PFAXROUTEDEVICEENABLE = ?*const anyopaque;
    pub const PFAXROUTEDEVICECHANGENOTIFICATION = ?*const anyopaque;
    pub const PFAXROUTEGETROUTINGINFO = ?*const anyopaque;
    pub const PFAXROUTESETROUTINGINFO = ?*const anyopaque;
    pub const PFAX_EXT_GET_DATA = ?*const anyopaque;
    pub const PFAX_EXT_SET_DATA = ?*const anyopaque;
    pub const PFAX_EXT_CONFIG_CHANGE = ?*const anyopaque;
    pub const PFAX_EXT_REGISTER_FOR_EVENTS = ?*const anyopaque;
    pub const PFAX_EXT_UNREGISTER_FOR_EVENTS = ?*const anyopaque;
    pub const PFAX_EXT_FREE_BUFFER = ?*const anyopaque;
    pub const PFAX_EXT_INITIALIZE_CONFIG = ?*const anyopaque;
};
