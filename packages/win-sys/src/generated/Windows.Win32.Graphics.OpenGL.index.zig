...
pub const aliases = struct {
    ...
    pub const PFNGLARRAYELEMENTEXTPROC = ?*const anyopaque;
    pub const PFNGLDRAWARRAYSEXTPROC = ?*const anyopaque;
    pub const PFNGLVERTEXPOINTEREXTPROC = ?*const anyopaque;
    pub const PFNGLNORMALPOINTEREXTPROC = ?*const anyopaque;
    pub const PFNGLCOLORPOINTEREXTPROC = ?*const anyopaque;
    pub const PFNGLINDEXPOINTEREXTPROC = ?*const anyopaque;
    pub const PFNGLTEXCOORDPOINTEREXTPROC = ?*const anyopaque;
    pub const PFNGLEDGEFLAGPOINTEREXTPROC = ?*const anyopaque;
    pub const PFNGLGETPOINTERVEXTPROC = ?*const anyopaque;
    pub const PFNGLARRAYELEMENTARRAYEXTPROC = ?*const anyopaque;
    pub const PFNGLDRAWRANGEELEMENTSWINPROC = ?*const anyopaque;
    pub const PFNGLADDSWAPHINTRECTWINPROC = ?*const anyopaque;
    pub const PFNGLCOLORTABLEEXTPROC = ?*const anyopaque;
    pub const PFNGLCOLORSUBTABLEEXTPROC = ?*const anyopaque;
    pub const PFNGLGETCOLORTABLEEXTPROC = ?*const anyopaque;
    pub const PFNGLGETCOLORTABLEPARAMETERIVEXTPROC = ?*const anyopaque;
    pub const PFNGLGETCOLORTABLEPARAMETERFVEXTPROC = ?*const anyopaque;
    pub const GLUquadricErrorProc = ?*const anyopaque;
    pub const GLUtessBeginProc = ?*const anyopaque;
    pub const GLUtessEdgeFlagProc = ?*const anyopaque;
    pub const GLUtessVertexProc = ?*const anyopaque;
    pub const GLUtessEndProc = ?*const anyopaque;
    pub const GLUtessErrorProc = ?*const anyopaque;
    pub const GLUtessCombineProc = ?*const anyopaque;
    pub const GLUtessBeginDataProc = ?*const anyopaque;
    pub const GLUtessEdgeFlagDataProc = ?*const anyopaque;
    pub const GLUtessVertexDataProc = ?*const anyopaque;
    pub const GLUtessEndDataProc = ?*const anyopaque;
    pub const GLUtessErrorDataProc = ?*const anyopaque;
    pub const GLUtessCombineDataProc = ?*const anyopaque;
    pub const GLUnurbsErrorProc = ?*const anyopaque;
};
