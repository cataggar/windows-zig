...
pub const aliases = struct {
    ...
    pub const alljoyn_applicationstatelistener_state_ptr = ?*const anyopaque;
    pub const alljoyn_keystorelistener_loadrequest_ptr = ?*const anyopaque;
    pub const alljoyn_keystorelistener_storerequest_ptr = ?*const anyopaque;
    pub const alljoyn_keystorelistener_acquireexclusivelock_ptr = ?*const anyopaque;
    pub const alljoyn_keystorelistener_releaseexclusivelock_ptr = ?*const anyopaque;
    pub const alljoyn_authlistener_requestcredentials_ptr = ?*const anyopaque;
    pub const alljoyn_authlistener_requestcredentialsasync_ptr = ?*const anyopaque;
    pub const alljoyn_authlistener_verifycredentials_ptr = ?*const anyopaque;
    pub const alljoyn_authlistener_verifycredentialsasync_ptr = ?*const anyopaque;
    pub const alljoyn_authlistener_securityviolation_ptr = ?*const anyopaque;
    pub const alljoyn_authlistener_authenticationcomplete_ptr = ?*const anyopaque;
    pub const alljoyn_buslistener_listener_registered_ptr = ?*const anyopaque;
    pub const alljoyn_buslistener_listener_unregistered_ptr = ?*const anyopaque;
    pub const alljoyn_buslistener_found_advertised_name_ptr = ?*const anyopaque;
    pub const alljoyn_buslistener_lost_advertised_name_ptr = ?*const anyopaque;
    pub const alljoyn_buslistener_name_owner_changed_ptr = ?*const anyopaque;
    pub const alljoyn_buslistener_bus_stopping_ptr = ?*const anyopaque;
    pub const alljoyn_buslistener_bus_disconnected_ptr = ?*const anyopaque;
    pub const alljoyn_buslistener_bus_prop_changed_ptr = ?*const anyopaque;
    pub const alljoyn_interfacedescription_translation_callback_ptr = ?*const anyopaque;
    pub const alljoyn_messagereceiver_methodhandler_ptr = ?*const anyopaque;
    pub const alljoyn_messagereceiver_replyhandler_ptr = ?*const anyopaque;
    pub const alljoyn_messagereceiver_signalhandler_ptr = ?*const anyopaque;
    pub const alljoyn_busobject_prop_get_ptr = ?*const anyopaque;
    pub const alljoyn_busobject_prop_set_ptr = ?*const anyopaque;
    pub const alljoyn_busobject_object_registration_ptr = ?*const anyopaque;
    pub const alljoyn_proxybusobject_listener_introspectcb_ptr = ?*const anyopaque;
    pub const alljoyn_proxybusobject_listener_getpropertycb_ptr = ?*const anyopaque;
    pub const alljoyn_proxybusobject_listener_getallpropertiescb_ptr = ?*const anyopaque;
    pub const alljoyn_proxybusobject_listener_setpropertycb_ptr = ?*const anyopaque;
    pub const alljoyn_proxybusobject_listener_propertieschanged_ptr = ?*const anyopaque;
    pub const alljoyn_permissionconfigurationlistener_factoryreset_ptr = ?*const anyopaque;
    pub const alljoyn_permissionconfigurationlistener_policychanged_ptr = ?*const anyopaque;
    pub const alljoyn_permissionconfigurationlistener_startmanagement_ptr = ?*const anyopaque;
    pub const alljoyn_permissionconfigurationlistener_endmanagement_ptr = ?*const anyopaque;
    pub const alljoyn_sessionlistener_sessionlost_ptr = ?*const anyopaque;
    pub const alljoyn_sessionlistener_sessionmemberadded_ptr = ?*const anyopaque;
    pub const alljoyn_sessionlistener_sessionmemberremoved_ptr = ?*const anyopaque;
    pub const alljoyn_sessionportlistener_acceptsessionjoiner_ptr = ?*const anyopaque;
    pub const alljoyn_sessionportlistener_sessionjoined_ptr = ?*const anyopaque;
    pub const alljoyn_about_announced_ptr = ?*const anyopaque;
    pub const alljoyn_busattachment_joinsessioncb_ptr = ?*const anyopaque;
    pub const alljoyn_busattachment_setlinktimeoutcb_ptr = ?*const anyopaque;
    pub const alljoyn_aboutdatalistener_getaboutdata_ptr = ?*const anyopaque;
    pub const alljoyn_aboutdatalistener_getannouncedaboutdata_ptr = ?*const anyopaque;
    pub const alljoyn_autopinger_destination_lost_ptr = ?*const anyopaque;
    pub const alljoyn_autopinger_destination_found_ptr = ?*const anyopaque;
    pub const alljoyn_observer_object_discovered_ptr = ?*const anyopaque;
    pub const alljoyn_observer_object_lost_ptr = ?*const anyopaque;
};
