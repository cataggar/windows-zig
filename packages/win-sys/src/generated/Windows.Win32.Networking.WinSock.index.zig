...
pub const aliases = struct {
    ...
    pub const LPCONDITIONPROC = ?*const anyopaque;
    pub const LPWSAOVERLAPPED_COMPLETION_ROUTINE = ?*const anyopaque;
    pub const LPFN_TRANSMITFILE = ?*const anyopaque;
    pub const LPFN_ACCEPTEX = ?*const anyopaque;
    pub const LPFN_GETACCEPTEXSOCKADDRS = ?*const anyopaque;
    pub const LPFN_TRANSMITPACKETS = ?*const anyopaque;
    pub const LPFN_CONNECTEX = ?*const anyopaque;
    pub const LPFN_DISCONNECTEX = ?*const anyopaque;
    pub const LPFN_WSARECVMSG = ?*const anyopaque;
    pub const LPFN_WSASENDMSG = ?*const anyopaque;
    pub const LPFN_WSAPOLL = ?*const anyopaque;
    pub const LPFN_RIORECEIVE = ?*const anyopaque;
    pub const LPFN_RIORECEIVEEX = ?*const anyopaque;
    pub const LPFN_RIOSEND = ?*const anyopaque;
    pub const LPFN_RIOSENDEX = ?*const anyopaque;
    pub const LPFN_RIOCLOSECOMPLETIONQUEUE = ?*const anyopaque;
    pub const LPFN_RIOCREATECOMPLETIONQUEUE = ?*const anyopaque;
    pub const LPFN_RIOCREATEREQUESTQUEUE = ?*const anyopaque;
    pub const LPFN_RIODEQUEUECOMPLETION = ?*const anyopaque;
    pub const LPFN_RIODEREGISTERBUFFER = ?*const anyopaque;
    pub const LPFN_RIONOTIFY = ?*const anyopaque;
    pub const LPFN_RIOREGISTERBUFFER = ?*const anyopaque;
    pub const LPFN_RIORESIZECOMPLETIONQUEUE = ?*const anyopaque;
    pub const LPFN_RIORESIZEREQUESTQUEUE = ?*const anyopaque;
    pub const LPBLOCKINGCALLBACK = ?*const anyopaque;
    pub const LPWSAUSERAPC = ?*const anyopaque;
    pub const LPWSPACCEPT = ?*const anyopaque;
    pub const LPWSPADDRESSTOSTRING = ?*const anyopaque;
    pub const LPWSPASYNCSELECT = ?*const anyopaque;
    pub const LPWSPBIND = ?*const anyopaque;
    pub const LPWSPCANCELBLOCKINGCALL = ?*const anyopaque;
    pub const LPWSPCLEANUP = ?*const anyopaque;
    pub const LPWSPCLOSESOCKET = ?*const anyopaque;
    pub const LPWSPCONNECT = ?*const anyopaque;
    pub const LPWSPDUPLICATESOCKET = ?*const anyopaque;
    pub const LPWSPENUMNETWORKEVENTS = ?*const anyopaque;
    pub const LPWSPEVENTSELECT = ?*const anyopaque;
    pub const LPWSPGETOVERLAPPEDRESULT = ?*const anyopaque;
    pub const LPWSPGETPEERNAME = ?*const anyopaque;
    pub const LPWSPGETSOCKNAME = ?*const anyopaque;
    pub const LPWSPGETSOCKOPT = ?*const anyopaque;
    pub const LPWSPGETQOSBYNAME = ?*const anyopaque;
    pub const LPWSPIOCTL = ?*const anyopaque;
    pub const LPWSPJOINLEAF = ?*const anyopaque;
    pub const LPWSPLISTEN = ?*const anyopaque;
    pub const LPWSPRECV = ?*const anyopaque;
    pub const LPWSPRECVDISCONNECT = ?*const anyopaque;
    pub const LPWSPRECVFROM = ?*const anyopaque;
    pub const LPWSPSELECT = ?*const anyopaque;
    pub const LPWSPSEND = ?*const anyopaque;
    pub const LPWSPSENDDISCONNECT = ?*const anyopaque;
    pub const LPWSPSENDTO = ?*const anyopaque;
    pub const LPWSPSETSOCKOPT = ?*const anyopaque;
    pub const LPWSPSHUTDOWN = ?*const anyopaque;
    pub const LPWSPSOCKET = ?*const anyopaque;
    pub const LPWSPSTRINGTOADDRESS = ?*const anyopaque;
    pub const LPWPUCLOSEEVENT = ?*const anyopaque;
    pub const LPWPUCLOSESOCKETHANDLE = ?*const anyopaque;
    pub const LPWPUCREATEEVENT = ?*const anyopaque;
    pub const LPWPUCREATESOCKETHANDLE = ?*const anyopaque;
    pub const LPWPUFDISSET = ?*const anyopaque;
    pub const LPWPUGETPROVIDERPATH = ?*const anyopaque;
    pub const LPWPUMODIFYIFSHANDLE = ?*const anyopaque;
    pub const LPWPUPOSTMESSAGE = ?*const anyopaque;
    pub const LPWPUQUERYBLOCKINGCALLBACK = ?*const anyopaque;
    pub const LPWPUQUERYSOCKETHANDLECONTEXT = ?*const anyopaque;
    pub const LPWPUQUEUEAPC = ?*const anyopaque;
    pub const LPWPURESETEVENT = ?*const anyopaque;
    pub const LPWPUSETEVENT = ?*const anyopaque;
    pub const LPWPUOPENCURRENTTHREAD = ?*const anyopaque;
    pub const LPWPUCLOSETHREAD = ?*const anyopaque;
    pub const LPWPUCOMPLETEOVERLAPPEDREQUEST = ?*const anyopaque;
    pub const LPWSPSTARTUP = ?*const anyopaque;
    pub const LPWSCENUMPROTOCOLS = ?*const anyopaque;
    pub const LPWSCDEINSTALLPROVIDER = ?*const anyopaque;
    pub const LPWSCINSTALLPROVIDER = ?*const anyopaque;
    pub const LPWSCGETPROVIDERPATH = ?*const anyopaque;
    pub const LPWSCUPDATEPROVIDER = ?*const anyopaque;
    pub const LPWSCINSTALLNAMESPACE = ?*const anyopaque;
    pub const LPWSCUNINSTALLNAMESPACE = ?*const anyopaque;
    pub const LPWSCENABLENSPROVIDER = ?*const anyopaque;
    pub const LPNSPCLEANUP = ?*const anyopaque;
    pub const LPNSPLOOKUPSERVICEBEGIN = ?*const anyopaque;
    pub const LPNSPLOOKUPSERVICENEXT = ?*const anyopaque;
    pub const LPNSPIOCTL = ?*const anyopaque;
    pub const LPNSPLOOKUPSERVICEEND = ?*const anyopaque;
    pub const LPNSPSETSERVICE = ?*const anyopaque;
    pub const LPNSPINSTALLSERVICECLASS = ?*const anyopaque;
    pub const LPNSPREMOVESERVICECLASS = ?*const anyopaque;
    pub const LPNSPGETSERVICECLASSINFO = ?*const anyopaque;
    pub const LPNSPSTARTUP = ?*const anyopaque;
    pub const LPNSPV2STARTUP = ?*const anyopaque;
    pub const LPNSPV2CLEANUP = ?*const anyopaque;
    pub const LPNSPV2LOOKUPSERVICEBEGIN = ?*const anyopaque;
    pub const LPNSPV2LOOKUPSERVICENEXTEX = ?*const anyopaque;
    pub const LPNSPV2LOOKUPSERVICEEND = ?*const anyopaque;
    pub const LPNSPV2SETSERVICEEX = ?*const anyopaque;
    pub const LPNSPV2CLIENTSESSIONRUNDOWN = ?*const anyopaque;
    pub const LPFN_NSPAPI = ?*const anyopaque;
    pub const LPSERVICE_CALLBACK_PROC = ?*const anyopaque;
    pub const LPLOOKUPSERVICE_COMPLETION_ROUTINE = ?*const anyopaque;
    pub const LPWSCWRITEPROVIDERORDER = ?*const anyopaque;
    pub const LPWSCWRITENAMESPACEORDER = ?*const anyopaque;
};
