...
pub const aliases = struct {
    ...
    pub const SslGetCipherSuitePRFHashAlgorithmFn = ?*const anyopaque;
    pub const PFN_NCRYPT_ALLOC = ?*const anyopaque;
    pub const PFN_NCRYPT_FREE = ?*const anyopaque;
    pub const PCRYPT_DECRYPT_PRIVATE_KEY_FUNC = ?*const anyopaque;
    pub const PCRYPT_ENCRYPT_PRIVATE_KEY_FUNC = ?*const anyopaque;
    pub const PCRYPT_RESOLVE_HCRYPTPROV_FUNC = ?*const anyopaque;
    pub const PFN_CRYPT_ALLOC = ?*const anyopaque;
    pub const PFN_CRYPT_FREE = ?*const anyopaque;
    pub const PFN_CRYPT_ENUM_OID_FUNC = ?*const anyopaque;
    pub const PFN_CRYPT_ENUM_OID_INFO = ?*const anyopaque;
    pub const PFN_CMSG_STREAM_OUTPUT = ?*const anyopaque;
    pub const PFN_CMSG_ALLOC = ?*const anyopaque;
    pub const PFN_CMSG_FREE = ?*const anyopaque;
    pub const PFN_CMSG_GEN_ENCRYPT_KEY = ?*const anyopaque;
    pub const PFN_CMSG_EXPORT_ENCRYPT_KEY = ?*const anyopaque;
    pub const PFN_CMSG_IMPORT_ENCRYPT_KEY = ?*const anyopaque;
    pub const PFN_CMSG_GEN_CONTENT_ENCRYPT_KEY = ?*const anyopaque;
    pub const PFN_CMSG_EXPORT_KEY_TRANS = ?*const anyopaque;
    pub const PFN_CMSG_EXPORT_KEY_AGREE = ?*const anyopaque;
    pub const PFN_CMSG_EXPORT_MAIL_LIST = ?*const anyopaque;
    pub const PFN_CMSG_IMPORT_KEY_TRANS = ?*const anyopaque;
    pub const PFN_CMSG_IMPORT_KEY_AGREE = ?*const anyopaque;
    pub const PFN_CMSG_IMPORT_MAIL_LIST = ?*const anyopaque;
    pub const PFN_CMSG_CNG_IMPORT_KEY_TRANS = ?*const anyopaque;
    pub const PFN_CMSG_CNG_IMPORT_KEY_AGREE = ?*const anyopaque;
    pub const PFN_CMSG_CNG_IMPORT_CONTENT_ENCRYPT_KEY = ?*const anyopaque;
    pub const PFN_CERT_DLL_OPEN_STORE_PROV_FUNC = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_CLOSE = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_READ_CERT = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_WRITE_CERT = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_DELETE_CERT = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_SET_CERT_PROPERTY = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_READ_CRL = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_WRITE_CRL = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_DELETE_CRL = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_SET_CRL_PROPERTY = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_READ_CTL = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_WRITE_CTL = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_DELETE_CTL = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_SET_CTL_PROPERTY = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_CONTROL = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_FIND_CERT = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_FREE_FIND_CERT = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_GET_CERT_PROPERTY = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_FIND_CRL = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_FREE_FIND_CRL = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_GET_CRL_PROPERTY = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_FIND_CTL = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_FREE_FIND_CTL = ?*const anyopaque;
    pub const PFN_CERT_STORE_PROV_GET_CTL_PROPERTY = ?*const anyopaque;
    pub const PFN_CERT_CREATE_CONTEXT_SORT_FUNC = ?*const anyopaque;
    pub const PFN_CERT_ENUM_SYSTEM_STORE_LOCATION = ?*const anyopaque;
    pub const PFN_CERT_ENUM_SYSTEM_STORE = ?*const anyopaque;
    pub const PFN_CERT_ENUM_PHYSICAL_STORE = ?*const anyopaque;
    pub const PFN_CRYPT_EXTRACT_ENCODED_SIGNATURE_PARAMETERS_FUNC = ?*const anyopaque;
    pub const PFN_CRYPT_SIGN_AND_ENCODE_HASH_FUNC = ?*const anyopaque;
    pub const PFN_CRYPT_VERIFY_ENCODED_SIGNATURE_FUNC = ?*const anyopaque;
    pub const PFN_CRYPT_EXPORT_PUBLIC_KEY_INFO_EX2_FUNC = ?*const anyopaque;
    pub const PFN_CRYPT_EXPORT_PUBLIC_KEY_INFO_FROM_BCRYPT_HANDLE_FUNC = ?*const anyopaque;
    pub const PFN_IMPORT_PUBLIC_KEY_INFO_EX2_FUNC = ?*const anyopaque;
    pub const PFN_IMPORT_PRIV_KEY_FUNC = ?*const anyopaque;
    pub const PFN_EXPORT_PRIV_KEY_FUNC = ?*const anyopaque;
    pub const PFN_CRYPT_GET_SIGNER_CERTIFICATE = ?*const anyopaque;
    pub const PFN_CRYPT_ASYNC_PARAM_FREE_FUNC = ?*const anyopaque;
    pub const PFN_FREE_ENCODED_OBJECT_FUNC = ?*const anyopaque;
    pub const PFN_CRYPT_CANCEL_RETRIEVAL = ?*const anyopaque;
    pub const PFN_CRYPT_ASYNC_RETRIEVAL_COMPLETION_FUNC = ?*const anyopaque;
    pub const PFN_CANCEL_ASYNC_RETRIEVAL_FUNC = ?*const anyopaque;
    pub const PFN_CRYPT_ENUM_KEYID_PROP = ?*const anyopaque;
    pub const PFN_CERT_CHAIN_FIND_BY_ISSUER_CALLBACK = ?*const anyopaque;
    pub const PFN_CERT_SERVER_OCSP_RESPONSE_UPDATE_CALLBACK = ?*const anyopaque;
    pub const PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FLUSH = ?*const anyopaque;
    pub const PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_GET = ?*const anyopaque;
    pub const PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_RELEASE = ?*const anyopaque;
    pub const PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE_PASSWORD = ?*const anyopaque;
    pub const PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE = ?*const anyopaque;
    pub const PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE_IDENTIFIER = ?*const anyopaque;
    pub const PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_INITIALIZE = ?*const anyopaque;
    pub const PFN_CERT_IS_WEAK_HASH = ?*const anyopaque;
    pub const PFNCryptStreamOutputCallback = ?*const anyopaque;
    pub const PFNCryptStreamOutputCallbackEx = ?*const anyopaque;
    pub const PFN_AUTHENTICODE_DIGEST_SIGN = ?*const anyopaque;
    pub const PFN_AUTHENTICODE_DIGEST_SIGN_EX = ?*const anyopaque;
    pub const PFN_AUTHENTICODE_DIGEST_SIGN_EX_WITHFILEHANDLE = ?*const anyopaque;
    pub const PFN_AUTHENTICODE_DIGEST_SIGN_WITHFILEHANDLE = ?*const anyopaque;
    pub const PFN_CRYPT_XML_WRITE_CALLBACK = ?*const anyopaque;
    pub const PFN_CRYPT_XML_DATA_PROVIDER_READ = ?*const anyopaque;
    pub const PFN_CRYPT_XML_DATA_PROVIDER_CLOSE = ?*const anyopaque;
    pub const PFN_CRYPT_XML_CREATE_TRANSFORM = ?*const anyopaque;
    pub const PFN_CRYPT_XML_ENUM_ALG_INFO = ?*const anyopaque;
    pub const CryptXmlDllGetInterface = ?*const anyopaque;
    pub const CryptXmlDllEncodeAlgorithm = ?*const anyopaque;
    pub const CryptXmlDllCreateDigest = ?*const anyopaque;
    pub const CryptXmlDllDigestData = ?*const anyopaque;
    pub const CryptXmlDllFinalizeDigest = ?*const anyopaque;
    pub const CryptXmlDllCloseDigest = ?*const anyopaque;
    pub const CryptXmlDllSignData = ?*const anyopaque;
    pub const CryptXmlDllVerifySignature = ?*const anyopaque;
    pub const CryptXmlDllGetAlgorithmInfo = ?*const anyopaque;
    pub const CryptXmlDllEncodeKeyValue = ?*const anyopaque;
    pub const CryptXmlDllCreateKey = ?*const anyopaque;
    pub const BCryptOpenAlgorithmProviderFn = ?*const anyopaque;
    pub const BCryptGetPropertyFn = ?*const anyopaque;
    pub const BCryptSetPropertyFn = ?*const anyopaque;
    pub const BCryptCloseAlgorithmProviderFn = ?*const anyopaque;
    pub const BCryptFreeBufferFn = ?*const anyopaque;
    pub const BCryptGenerateSymmetricKeyFn = ?*const anyopaque;
    pub const BCryptGenerateKeyPairFn = ?*const anyopaque;
    pub const BCryptEncryptFn = ?*const anyopaque;
    pub const BCryptDecryptFn = ?*const anyopaque;
    pub const BCryptExportKeyFn = ?*const anyopaque;
    pub const BCryptImportKeyFn = ?*const anyopaque;
    pub const BCryptImportKeyPairFn = ?*const anyopaque;
    pub const BCryptDuplicateKeyFn = ?*const anyopaque;
    pub const BCryptFinalizeKeyPairFn = ?*const anyopaque;
    pub const BCryptDestroyKeyFn = ?*const anyopaque;
    pub const BCryptDestroySecretFn = ?*const anyopaque;
    pub const BCryptSignHashFn = ?*const anyopaque;
    pub const BCryptVerifySignatureFn = ?*const anyopaque;
    pub const BCryptSecretAgreementFn = ?*const anyopaque;
    pub const BCryptDeriveKeyFn = ?*const anyopaque;
    pub const BCryptKeyDerivationFn = ?*const anyopaque;
    pub const BCryptCreateHashFn = ?*const anyopaque;
    pub const BCryptHashDataFn = ?*const anyopaque;
    pub const BCryptFinishHashFn = ?*const anyopaque;
    pub const BCryptCreateMultiHashFn = ?*const anyopaque;
    pub const BCryptProcessMultiOperationsFn = ?*const anyopaque;
    pub const BCryptDuplicateHashFn = ?*const anyopaque;
    pub const BCryptDestroyHashFn = ?*const anyopaque;
    pub const BCryptGenRandomFn = ?*const anyopaque;
    pub const BCryptDeriveKeyCapiFn = ?*const anyopaque;
    pub const BCryptDeriveKeyPBKDF2Fn = ?*const anyopaque;
    pub const GetCipherInterfaceFn = ?*const anyopaque;
    pub const GetHashInterfaceFn = ?*const anyopaque;
    pub const GetAsymmetricEncryptionInterfaceFn = ?*const anyopaque;
    pub const GetSecretAgreementInterfaceFn = ?*const anyopaque;
    pub const GetSignatureInterfaceFn = ?*const anyopaque;
    pub const GetRngInterfaceFn = ?*const anyopaque;
    pub const GetKeyDerivationInterfaceFn = ?*const anyopaque;
    pub const NCryptOpenStorageProviderFn = ?*const anyopaque;
    pub const NCryptEnumAlgorithmsFn = ?*const anyopaque;
    pub const NCryptIsAlgSupportedFn = ?*const anyopaque;
    pub const NCryptEnumKeysFn = ?*const anyopaque;
    pub const NCryptEnumStorageProvidersFn = ?*const anyopaque;
    pub const NCryptFreeBufferFn = ?*const anyopaque;
    pub const NCryptOpenKeyFn = ?*const anyopaque;
    pub const NCryptCreatePersistedKeyFn = ?*const anyopaque;
    pub const NCryptGetProviderPropertyFn = ?*const anyopaque;
    pub const NCryptGetKeyPropertyFn = ?*const anyopaque;
    pub const NCryptSetProviderPropertyFn = ?*const anyopaque;
    pub const NCryptSetKeyPropertyFn = ?*const anyopaque;
    pub const NCryptFinalizeKeyFn = ?*const anyopaque;
    pub const NCryptEncryptFn = ?*const anyopaque;
    pub const NCryptDecryptFn = ?*const anyopaque;
    pub const NCryptImportKeyFn = ?*const anyopaque;
    pub const NCryptExportKeyFn = ?*const anyopaque;
    pub const NCryptSignHashFn = ?*const anyopaque;
    pub const NCryptVerifySignatureFn = ?*const anyopaque;
    pub const NCryptDeleteKeyFn = ?*const anyopaque;
    pub const NCryptFreeProviderFn = ?*const anyopaque;
    pub const NCryptFreeKeyFn = ?*const anyopaque;
    pub const NCryptFreeSecretFn = ?*const anyopaque;
    pub const NCryptPromptUserFn = ?*const anyopaque;
    pub const NCryptNotifyChangeKeyFn = ?*const anyopaque;
    pub const NCryptSecretAgreementFn = ?*const anyopaque;
    pub const NCryptDeriveKeyFn = ?*const anyopaque;
    pub const NCryptKeyDerivationFn = ?*const anyopaque;
    pub const NCryptCreateClaimFn = ?*const anyopaque;
    pub const NCryptVerifyClaimFn = ?*const anyopaque;
    pub const GetKeyStorageInterfaceFn = ?*const anyopaque;
    pub const SslComputeClientAuthHashFn = ?*const anyopaque;
    pub const SslComputeEapKeyBlockFn = ?*const anyopaque;
    pub const SslComputeFinishedHashFn = ?*const anyopaque;
    pub const SslCreateEphemeralKeyFn = ?*const anyopaque;
    pub const SslCreateHandshakeHashFn = ?*const anyopaque;
    pub const SslDecryptPacketFn = ?*const anyopaque;
    pub const SslEncryptPacketFn = ?*const anyopaque;
    pub const SslEnumCipherSuitesFn = ?*const anyopaque;
    pub const SslEnumCipherSuitesExFn = ?*const anyopaque;
    pub const SslEnumEccCurvesFn = ?*const anyopaque;
    pub const SslExportKeyFn = ?*const anyopaque;
    pub const SslFreeBufferFn = ?*const anyopaque;
    pub const SslFreeObjectFn = ?*const anyopaque;
    pub const SslGenerateMasterKeyFn = ?*const anyopaque;
    pub const SslGenerateSessionKeysFn = ?*const anyopaque;
    pub const SslGetKeyPropertyFn = ?*const anyopaque;
    pub const SslGetProviderPropertyFn = ?*const anyopaque;
    pub const SslHashHandshakeFn = ?*const anyopaque;
    pub const SslImportKeyFn = ?*const anyopaque;
    pub const SslImportMasterKeyFn = ?*const anyopaque;
    pub const SslLookupCipherSuiteInfoFn = ?*const anyopaque;
    pub const SslOpenPrivateKeyFn = ?*const anyopaque;
    pub const SslOpenProviderFn = ?*const anyopaque;
    pub const SslSignHashFn = ?*const anyopaque;
    pub const SslVerifySignatureFn = ?*const anyopaque;
    pub const SslLookupCipherLengthsFn = ?*const anyopaque;
    pub const SslCreateClientAuthHashFn = ?*const anyopaque;
    pub const SslComputeSessionHashFn = ?*const anyopaque;
    pub const SslGeneratePreMasterKeyFn = ?*const anyopaque;
    pub const SslExportKeyingMaterialFn = ?*const anyopaque;
    pub const SslExtractEarlyKeyFn = ?*const anyopaque;
    pub const SslExtractHandshakeKeyFn = ?*const anyopaque;
    pub const SslExtractMasterKeyFn = ?*const anyopaque;
    pub const SslExpandTrafficKeysFn = ?*const anyopaque;
    pub const SslExpandWriteKeyFn = ?*const anyopaque;
    pub const SslExpandExporterMasterKeyFn = ?*const anyopaque;
    pub const SslExpandResumptionMasterKeyFn = ?*const anyopaque;
    pub const SslDuplicateTranscriptHashFn = ?*const anyopaque;
    pub const SslExpandBinderKeyFn = ?*const anyopaque;
    pub const SslExpandPreSharedKeyFn = ?*const anyopaque;
    pub const GetSChannelInterfaceFn = ?*const anyopaque;
    pub const SslInitializeInterfaceFn = ?*const anyopaque;
    pub const PFN_OFFLOAD_MOD_EXPO = ?*const anyopaque;
    pub const CRYPT_VERIFY_IMAGE_A = ?*const anyopaque;
    pub const CRYPT_VERIFY_IMAGE_W = ?*const anyopaque;
    pub const CRYPT_RETURN_HWND = ?*const anyopaque;
    pub const PFN_CARD_ACQUIRE_CONTEXT = ?*const anyopaque;
    pub const PFN_CARD_DELETE_CONTEXT = ?*const anyopaque;
    pub const PFN_CARD_QUERY_CAPABILITIES = ?*const anyopaque;
    pub const PFN_CARD_GET_CHALLENGE_EX = ?*const anyopaque;
    pub const PFN_CARD_AUTHENTICATE_EX = ?*const anyopaque;
    pub const PFN_CARD_CHANGE_AUTHENTICATOR_EX = ?*const anyopaque;
    pub const PFN_CARD_DEAUTHENTICATE_EX = ?*const anyopaque;
    pub const PFN_CARD_DELETE_CONTAINER = ?*const anyopaque;
    pub const PFN_CARD_CREATE_CONTAINER = ?*const anyopaque;
    pub const PFN_CARD_CREATE_CONTAINER_EX = ?*const anyopaque;
    pub const PFN_CARD_GET_CONTAINER_INFO = ?*const anyopaque;
    pub const PFN_CARD_AUTHENTICATE_PIN = ?*const anyopaque;
    pub const PFN_CARD_GET_CHALLENGE = ?*const anyopaque;
    pub const PFN_CARD_AUTHENTICATE_CHALLENGE = ?*const anyopaque;
    pub const PFN_CARD_UNBLOCK_PIN = ?*const anyopaque;
    pub const PFN_CARD_CHANGE_AUTHENTICATOR = ?*const anyopaque;
    pub const PFN_CARD_DEAUTHENTICATE = ?*const anyopaque;
    pub const PFN_CARD_CREATE_DIRECTORY = ?*const anyopaque;
    pub const PFN_CARD_DELETE_DIRECTORY = ?*const anyopaque;
    pub const PFN_CARD_CREATE_FILE = ?*const anyopaque;
    pub const PFN_CARD_READ_FILE = ?*const anyopaque;
    pub const PFN_CARD_WRITE_FILE = ?*const anyopaque;
    pub const PFN_CARD_DELETE_FILE = ?*const anyopaque;
    pub const PFN_CARD_ENUM_FILES = ?*const anyopaque;
    pub const PFN_CARD_GET_FILE_INFO = ?*const anyopaque;
    pub const PFN_CARD_QUERY_FREE_SPACE = ?*const anyopaque;
    pub const PFN_CARD_QUERY_KEY_SIZES = ?*const anyopaque;
    pub const PFN_CARD_RSA_DECRYPT = ?*const anyopaque;
    pub const PFN_CARD_SIGN_DATA = ?*const anyopaque;
    pub const PFN_CARD_CONSTRUCT_DH_AGREEMENT = ?*const anyopaque;
    pub const PFN_CARD_DERIVE_KEY = ?*const anyopaque;
    pub const PFN_CARD_DESTROY_DH_AGREEMENT = ?*const anyopaque;
    pub const PFN_CSP_GET_DH_AGREEMENT = ?*const anyopaque;
    pub const PFN_CSP_ALLOC = ?*const anyopaque;
    pub const PFN_CSP_REALLOC = ?*const anyopaque;
    pub const PFN_CSP_FREE = ?*const anyopaque;
    pub const PFN_CSP_CACHE_ADD_FILE = ?*const anyopaque;
    pub const PFN_CSP_CACHE_LOOKUP_FILE = ?*const anyopaque;
    pub const PFN_CSP_CACHE_DELETE_FILE = ?*const anyopaque;
    pub const PFN_CSP_PAD_DATA = ?*const anyopaque;
    pub const PFN_CSP_UNPAD_DATA = ?*const anyopaque;
    pub const PFN_CARD_GET_CONTAINER_PROPERTY = ?*const anyopaque;
    pub const PFN_CARD_SET_CONTAINER_PROPERTY = ?*const anyopaque;
    pub const PFN_CARD_GET_PROPERTY = ?*const anyopaque;
    pub const PFN_CARD_SET_PROPERTY = ?*const anyopaque;
    pub const PFN_MD_IMPORT_SESSION_KEY = ?*const anyopaque;
    pub const PFN_MD_ENCRYPT_DATA = ?*const anyopaque;
    pub const PFN_CARD_GET_SHARED_KEY_HANDLE = ?*const anyopaque;
    pub const PFN_CARD_DESTROY_KEY = ?*const anyopaque;
    pub const PFN_CARD_GET_ALGORITHM_PROPERTY = ?*const anyopaque;
    pub const PFN_CARD_GET_KEY_PROPERTY = ?*const anyopaque;
    pub const PFN_CARD_SET_KEY_PROPERTY = ?*const anyopaque;
    pub const PFN_CARD_IMPORT_SESSION_KEY = ?*const anyopaque;
    pub const PFN_CARD_PROCESS_ENCRYPTED_DATA = ?*const anyopaque;
};
