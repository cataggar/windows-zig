...
pub const aliases = struct {
    ...
    pub const PSAM_PASSWORD_NOTIFICATION_ROUTINE = ?*const anyopaque;
    pub const PSAM_INIT_NOTIFICATION_ROUTINE = ?*const anyopaque;
    pub const PSAM_PASSWORD_FILTER_ROUTINE = ?*const anyopaque;
    pub const SEC_GET_KEY_FN = ?*const anyopaque;
    pub const ACQUIRE_CREDENTIALS_HANDLE_FN_W = ?*const anyopaque;
    pub const ACQUIRE_CREDENTIALS_HANDLE_FN_A = ?*const anyopaque;
    pub const FREE_CREDENTIALS_HANDLE_FN = ?*const anyopaque;
    pub const ADD_CREDENTIALS_FN_W = ?*const anyopaque;
    pub const ADD_CREDENTIALS_FN_A = ?*const anyopaque;
    pub const CHANGE_PASSWORD_FN_W = ?*const anyopaque;
    pub const CHANGE_PASSWORD_FN_A = ?*const anyopaque;
    pub const INITIALIZE_SECURITY_CONTEXT_FN_W = ?*const anyopaque;
    pub const INITIALIZE_SECURITY_CONTEXT_FN_A = ?*const anyopaque;
    pub const ACCEPT_SECURITY_CONTEXT_FN = ?*const anyopaque;
    pub const COMPLETE_AUTH_TOKEN_FN = ?*const anyopaque;
    pub const IMPERSONATE_SECURITY_CONTEXT_FN = ?*const anyopaque;
    pub const REVERT_SECURITY_CONTEXT_FN = ?*const anyopaque;
    pub const QUERY_SECURITY_CONTEXT_TOKEN_FN = ?*const anyopaque;
    pub const DELETE_SECURITY_CONTEXT_FN = ?*const anyopaque;
    pub const APPLY_CONTROL_TOKEN_FN = ?*const anyopaque;
    pub const QUERY_CONTEXT_ATTRIBUTES_FN_W = ?*const anyopaque;
    pub const QUERY_CONTEXT_ATTRIBUTES_EX_FN_W = ?*const anyopaque;
    pub const QUERY_CONTEXT_ATTRIBUTES_FN_A = ?*const anyopaque;
    pub const QUERY_CONTEXT_ATTRIBUTES_EX_FN_A = ?*const anyopaque;
    pub const SET_CONTEXT_ATTRIBUTES_FN_W = ?*const anyopaque;
    pub const SET_CONTEXT_ATTRIBUTES_FN_A = ?*const anyopaque;
    pub const QUERY_CREDENTIALS_ATTRIBUTES_FN_W = ?*const anyopaque;
    pub const QUERY_CREDENTIALS_ATTRIBUTES_EX_FN_W = ?*const anyopaque;
    pub const QUERY_CREDENTIALS_ATTRIBUTES_FN_A = ?*const anyopaque;
    pub const QUERY_CREDENTIALS_ATTRIBUTES_EX_FN_A = ?*const anyopaque;
    pub const SET_CREDENTIALS_ATTRIBUTES_FN_W = ?*const anyopaque;
    pub const SET_CREDENTIALS_ATTRIBUTES_FN_A = ?*const anyopaque;
    pub const FREE_CONTEXT_BUFFER_FN = ?*const anyopaque;
    pub const MAKE_SIGNATURE_FN = ?*const anyopaque;
    pub const VERIFY_SIGNATURE_FN = ?*const anyopaque;
    pub const ENCRYPT_MESSAGE_FN = ?*const anyopaque;
    pub const DECRYPT_MESSAGE_FN = ?*const anyopaque;
    pub const ENUMERATE_SECURITY_PACKAGES_FN_W = ?*const anyopaque;
    pub const ENUMERATE_SECURITY_PACKAGES_FN_A = ?*const anyopaque;
    pub const QUERY_SECURITY_PACKAGE_INFO_FN_W = ?*const anyopaque;
    pub const QUERY_SECURITY_PACKAGE_INFO_FN_A = ?*const anyopaque;
    pub const EXPORT_SECURITY_CONTEXT_FN = ?*const anyopaque;
    pub const IMPORT_SECURITY_CONTEXT_FN_W = ?*const anyopaque;
    pub const IMPORT_SECURITY_CONTEXT_FN_A = ?*const anyopaque;
    pub const INIT_SECURITY_INTERFACE_A = ?*const anyopaque;
    pub const INIT_SECURITY_INTERFACE_W = ?*const anyopaque;
    pub const PLSA_CREATE_LOGON_SESSION = ?*const anyopaque;
    pub const PLSA_DELETE_LOGON_SESSION = ?*const anyopaque;
    pub const PLSA_ADD_CREDENTIAL = ?*const anyopaque;
    pub const PLSA_GET_CREDENTIALS = ?*const anyopaque;
    pub const PLSA_DELETE_CREDENTIAL = ?*const anyopaque;
    pub const PLSA_ALLOCATE_LSA_HEAP = ?*const anyopaque;
    pub const PLSA_FREE_LSA_HEAP = ?*const anyopaque;
    pub const PLSA_ALLOCATE_PRIVATE_HEAP = ?*const anyopaque;
    pub const PLSA_FREE_PRIVATE_HEAP = ?*const anyopaque;
    pub const PLSA_ALLOCATE_CLIENT_BUFFER = ?*const anyopaque;
    pub const PLSA_FREE_CLIENT_BUFFER = ?*const anyopaque;
    pub const PLSA_COPY_TO_CLIENT_BUFFER = ?*const anyopaque;
    pub const PLSA_COPY_FROM_CLIENT_BUFFER = ?*const anyopaque;
    pub const PLSA_AP_INITIALIZE_PACKAGE = ?*const anyopaque;
    pub const PLSA_AP_LOGON_USER = ?*const anyopaque;
    pub const PLSA_AP_LOGON_USER_EX = ?*const anyopaque;
    pub const PLSA_AP_CALL_PACKAGE = ?*const anyopaque;
    pub const PLSA_AP_CALL_PACKAGE_PASSTHROUGH = ?*const anyopaque;
    pub const PLSA_AP_LOGON_TERMINATED = ?*const anyopaque;
    pub const PSAM_CREDENTIAL_UPDATE_NOTIFY_ROUTINE = ?*const anyopaque;
    pub const PSAM_CREDENTIAL_UPDATE_REGISTER_ROUTINE = ?*const anyopaque;
    pub const PSAM_CREDENTIAL_UPDATE_FREE_ROUTINE = ?*const anyopaque;
    pub const PSAM_CREDENTIAL_UPDATE_REGISTER_MAPPED_ENTRYPOINTS_ROUTINE = ?*const anyopaque;
    pub const PLSA_CALLBACK_FUNCTION = ?*const anyopaque;
    pub const PLSA_REDIRECTED_LOGON_INIT = ?*const anyopaque;
    pub const PLSA_REDIRECTED_LOGON_CALLBACK = ?*const anyopaque;
    pub const PLSA_REDIRECTED_LOGON_CLEANUP_CALLBACK = ?*const anyopaque;
    pub const PLSA_REDIRECTED_LOGON_GET_LOGON_CREDS = ?*const anyopaque;
    pub const PLSA_REDIRECTED_LOGON_GET_SUPP_CREDS = ?*const anyopaque;
    pub const PLSA_REDIRECTED_LOGON_GET_SID = ?*const anyopaque;
    pub const PLSA_IMPERSONATE_CLIENT = ?*const anyopaque;
    pub const PLSA_UNLOAD_PACKAGE = ?*const anyopaque;
    pub const PLSA_DUPLICATE_HANDLE = ?*const anyopaque;
    pub const PLSA_SAVE_SUPPLEMENTAL_CREDENTIALS = ?*const anyopaque;
    pub const PLSA_CREATE_THREAD = ?*const anyopaque;
    pub const PLSA_GET_CLIENT_INFO = ?*const anyopaque;
    pub const PLSA_GET_CLIENT_INFO_EX = ?*const anyopaque;
    pub const PLSA_REGISTER_NOTIFICATION = ?*const anyopaque;
    pub const PLSA_CANCEL_NOTIFICATION = ?*const anyopaque;
    pub const PLSA_MAP_BUFFER = ?*const anyopaque;
    pub const PLSA_CREATE_TOKEN = ?*const anyopaque;
    pub const PLSA_CREATE_TOKEN_EX = ?*const anyopaque;
    pub const PLSA_AUDIT_LOGON = ?*const anyopaque;
    pub const PLSA_CALL_PACKAGE = ?*const anyopaque;
    pub const PLSA_CALL_PACKAGEEX = ?*const anyopaque;
    pub const PLSA_CALL_PACKAGE_PASSTHROUGH = ?*const anyopaque;
    pub const PLSA_GET_CALL_INFO = ?*const anyopaque;
    pub const PLSA_CREATE_SHARED_MEMORY = ?*const anyopaque;
    pub const PLSA_ALLOCATE_SHARED_MEMORY = ?*const anyopaque;
    pub const PLSA_FREE_SHARED_MEMORY = ?*const anyopaque;
    pub const PLSA_DELETE_SHARED_MEMORY = ?*const anyopaque;
    pub const PLSA_GET_APP_MODE_INFO = ?*const anyopaque;
    pub const PLSA_SET_APP_MODE_INFO = ?*const anyopaque;
    pub const PLSA_GET_SECPKG_FAILURE_REASON = ?*const anyopaque;
    pub const PLSA_SET_SECPKG_FAILURE_REASON = ?*const anyopaque;
    pub const PLSA_OPEN_SAM_USER = ?*const anyopaque;
    pub const PLSA_GET_USER_CREDENTIALS = ?*const anyopaque;
    pub const PLSA_GET_USER_AUTH_DATA = ?*const anyopaque;
    pub const PLSA_CLOSE_SAM_USER = ?*const anyopaque;
    pub const PLSA_GET_AUTH_DATA_FOR_USER = ?*const anyopaque;
    pub const PLSA_CONVERT_AUTH_DATA_TO_TOKEN = ?*const anyopaque;
    pub const PLSA_CRACK_SINGLE_NAME = ?*const anyopaque;
    pub const PLSA_AUDIT_ACCOUNT_LOGON = ?*const anyopaque;
    pub const PLSA_CLIENT_CALLBACK = ?*const anyopaque;
    pub const PLSA_REGISTER_CALLBACK = ?*const anyopaque;
    pub const PLSA_GET_EXTENDED_CALL_FLAGS = ?*const anyopaque;
    pub const PLSA_UPDATE_PRIMARY_CREDENTIALS = ?*const anyopaque;
    pub const PLSA_PROTECT_MEMORY = ?*const anyopaque;
    pub const PLSA_OPEN_TOKEN_BY_LOGON_ID = ?*const anyopaque;
    pub const PLSA_EXPAND_AUTH_DATA_FOR_DOMAIN = ?*const anyopaque;
    pub const PLSA_GET_SERVICE_ACCOUNT_PASSWORD = ?*const anyopaque;
    pub const PLSA_AUDIT_LOGON_EX = ?*const anyopaque;
    pub const PLSA_CHECK_PROTECTED_USER_BY_TOKEN = ?*const anyopaque;
    pub const PLSA_QUERY_CLIENT_REQUEST = ?*const anyopaque;
    pub const CredReadFn = ?*const anyopaque;
    pub const CredReadDomainCredentialsFn = ?*const anyopaque;
    pub const CredFreeCredentialsFn = ?*const anyopaque;
    pub const CredWriteFn = ?*const anyopaque;
    pub const CrediUnmarshalandDecodeStringFn = ?*const anyopaque;
    pub const PLSA_LOCATE_PKG_BY_ID = ?*const anyopaque;
    pub const SpInitializeFn = ?*const anyopaque;
    pub const SpShutdownFn = ?*const anyopaque;
    pub const SpGetInfoFn = ?*const anyopaque;
    pub const SpGetExtendedInformationFn = ?*const anyopaque;
    pub const SpSetExtendedInformationFn = ?*const anyopaque;
    pub const PLSA_AP_LOGON_USER_EX2 = ?*const anyopaque;
    pub const PLSA_AP_LOGON_USER_EX3 = ?*const anyopaque;
    pub const PLSA_AP_PRE_LOGON_USER_SURROGATE = ?*const anyopaque;
    pub const PLSA_AP_POST_LOGON_USER_SURROGATE = ?*const anyopaque;
    pub const SpAcceptCredentialsFn = ?*const anyopaque;
    pub const SpAcquireCredentialsHandleFn = ?*const anyopaque;
    pub const SpFreeCredentialsHandleFn = ?*const anyopaque;
    pub const SpQueryCredentialsAttributesFn = ?*const anyopaque;
    pub const SpSetCredentialsAttributesFn = ?*const anyopaque;
    pub const SpAddCredentialsFn = ?*const anyopaque;
    pub const SpSaveCredentialsFn = ?*const anyopaque;
    pub const SpGetCredentialsFn = ?*const anyopaque;
    pub const SpDeleteCredentialsFn = ?*const anyopaque;
    pub const SpInitLsaModeContextFn = ?*const anyopaque;
    pub const SpDeleteContextFn = ?*const anyopaque;
    pub const SpApplyControlTokenFn = ?*const anyopaque;
    pub const SpAcceptLsaModeContextFn = ?*const anyopaque;
    pub const SpGetUserInfoFn = ?*const anyopaque;
    pub const SpQueryContextAttributesFn = ?*const anyopaque;
    pub const SpSetContextAttributesFn = ?*const anyopaque;
    pub const SpChangeAccountPasswordFn = ?*const anyopaque;
    pub const SpQueryMetaDataFn = ?*const anyopaque;
    pub const SpExchangeMetaDataFn = ?*const anyopaque;
    pub const SpGetCredUIContextFn = ?*const anyopaque;
    pub const SpUpdateCredentialsFn = ?*const anyopaque;
    pub const SpValidateTargetInfoFn = ?*const anyopaque;
    pub const SpExtractTargetInfoFn = ?*const anyopaque;
    pub const LSA_AP_POST_LOGON_USER = ?*const anyopaque;
    pub const SpGetRemoteCredGuardLogonBufferFn = ?*const anyopaque;
    pub const SpGetRemoteCredGuardSupplementalCredsFn = ?*const anyopaque;
    pub const SpGetTbalSupplementalCredsFn = ?*const anyopaque;
    pub const SpInstanceInitFn = ?*const anyopaque;
    pub const SpInitUserModeContextFn = ?*const anyopaque;
    pub const SpMakeSignatureFn = ?*const anyopaque;
    pub const SpVerifySignatureFn = ?*const anyopaque;
    pub const SpSealMessageFn = ?*const anyopaque;
    pub const SpUnsealMessageFn = ?*const anyopaque;
    pub const SpGetContextTokenFn = ?*const anyopaque;
    pub const SpExportSecurityContextFn = ?*const anyopaque;
    pub const SpImportSecurityContextFn = ?*const anyopaque;
    pub const SpCompleteAuthTokenFn = ?*const anyopaque;
    pub const SpFormatCredentialsFn = ?*const anyopaque;
    pub const SpMarshallSupplementalCredsFn = ?*const anyopaque;
    pub const SpMarshalAttributeDataFn = ?*const anyopaque;
    pub const SpLsaModeInitializeFn = ?*const anyopaque;
    pub const SpUserModeInitializeFn = ?*const anyopaque;
    pub const PKSEC_CREATE_CONTEXT_LIST = ?*const anyopaque;
    pub const PKSEC_INSERT_LIST_ENTRY = ?*const anyopaque;
    pub const PKSEC_REFERENCE_LIST_ENTRY = ?*const anyopaque;
    pub const PKSEC_DEREFERENCE_LIST_ENTRY = ?*const anyopaque;
    pub const PKSEC_SERIALIZE_WINNT_AUTH_DATA = ?*const anyopaque;
    pub const PKSEC_SERIALIZE_SCHANNEL_AUTH_DATA = ?*const anyopaque;
    pub const PKSEC_LOCATE_PKG_BY_ID = ?*const anyopaque;
    pub const KspInitPackageFn = ?*const anyopaque;
    pub const KspDeleteContextFn = ?*const anyopaque;
    pub const KspInitContextFn = ?*const anyopaque;
    pub const KspMakeSignatureFn = ?*const anyopaque;
    pub const KspVerifySignatureFn = ?*const anyopaque;
    pub const KspSealMessageFn = ?*const anyopaque;
    pub const KspUnsealMessageFn = ?*const anyopaque;
    pub const KspGetTokenFn = ?*const anyopaque;
    pub const KspQueryAttributesFn = ?*const anyopaque;
    pub const KspCompleteTokenFn = ?*const anyopaque;
    pub const KspMapHandleFn = ?*const anyopaque;
    pub const KspSetPagingModeFn = ?*const anyopaque;
    pub const KspSerializeAuthDataFn = ?*const anyopaque;
    pub const SSL_EMPTY_CACHE_FN_A = ?*const anyopaque;
    pub const SSL_EMPTY_CACHE_FN_W = ?*const anyopaque;
    pub const SSL_CRACK_CERTIFICATE_FN = ?*const anyopaque;
    pub const SSL_FREE_CERTIFICATE_FN = ?*const anyopaque;
    pub const SslGetServerIdentityFn = ?*const anyopaque;
    pub const SslGetExtensionsFn = ?*const anyopaque;
    pub const SslDeserializeCertificateStoreFn = ?*const anyopaque;
};
