...
pub const userCLIPFORMAT = opaque {};
pub const GDI_NONREMOTE = opaque {};
pub const userHGLOBAL = opaque {};
pub const userHMETAFILE = opaque {};
pub const remoteMETAFILEPICT = opaque {};
pub const userHMETAFILEPICT = opaque {};
pub const userHENHMETAFILE = opaque {};
...
pub const userHBITMAP = opaque {};
pub const userHPALETTE = opaque {};
pub const RemotableHandle = opaque {};
