...
pub const aliases = struct {
    ...
    pub const PFN_PRINTING_ENUMPORTS = ?*const anyopaque;
    pub const PFN_PRINTING_OPENPORT = ?*const anyopaque;
    pub const PFN_PRINTING_OPENPORTEX = ?*const anyopaque;
    pub const PFN_PRINTING_STARTDOCPORT = ?*const anyopaque;
    pub const PFN_PRINTING_WRITEPORT = ?*const anyopaque;
    pub const PFN_PRINTING_READPORT = ?*const anyopaque;
    pub const PFN_PRINTING_ENDDOCPORT = ?*const anyopaque;
    pub const PFN_PRINTING_CLOSEPORT = ?*const anyopaque;
    pub const PFN_PRINTING_ADDPORT = ?*const anyopaque;
    pub const PFN_PRINTING_ADDPORTEX = ?*const anyopaque;
    pub const PFN_PRINTING_CONFIGUREPORT = ?*const anyopaque;
    pub const PFN_PRINTING_DELETEPORT = ?*const anyopaque;
    pub const PFN_PRINTING_GETPRINTERDATAFROMPORT = ?*const anyopaque;
    pub const PFN_PRINTING_SETPORTTIMEOUTS = ?*const anyopaque;
    pub const PFN_PRINTING_XCVOPENPORT = ?*const anyopaque;
    pub const PFN_PRINTING_XCVDATAPORT = ?*const anyopaque;
    pub const PFN_PRINTING_XCVCLOSEPORT = ?*const anyopaque;
    pub const PFN_PRINTING_ENUMPORTS2 = ?*const anyopaque;
    pub const PFN_PRINTING_OPENPORT2 = ?*const anyopaque;
    pub const PFN_PRINTING_OPENPORTEX2 = ?*const anyopaque;
    pub const PFN_PRINTING_STARTDOCPORT2 = ?*const anyopaque;
    pub const PFN_PRINTING_WRITEPORT2 = ?*const anyopaque;
    pub const PFN_PRINTING_READPORT2 = ?*const anyopaque;
    pub const PFN_PRINTING_ENDDOCPORT2 = ?*const anyopaque;
    pub const PFN_PRINTING_CLOSEPORT2 = ?*const anyopaque;
    pub const PFN_PRINTING_ADDPORT2 = ?*const anyopaque;
    pub const PFN_PRINTING_ADDPORTEX2 = ?*const anyopaque;
    pub const PFN_PRINTING_CONFIGUREPORT2 = ?*const anyopaque;
    pub const PFN_PRINTING_DELETEPORT2 = ?*const anyopaque;
    pub const PFN_PRINTING_GETPRINTERDATAFROMPORT2 = ?*const anyopaque;
    pub const PFN_PRINTING_SETPORTTIMEOUTS2 = ?*const anyopaque;
    pub const PFN_PRINTING_XCVOPENPORT2 = ?*const anyopaque;
    pub const PFN_PRINTING_XCVDATAPORT2 = ?*const anyopaque;
    pub const PFN_PRINTING_XCVCLOSEPORT2 = ?*const anyopaque;
    pub const PFN_PRINTING_SHUTDOWN2 = ?*const anyopaque;
    pub const PFN_PRINTING_SENDRECVBIDIDATAFROMPORT2 = ?*const anyopaque;
    pub const PFN_PRINTING_NOTIFYUSEDPORTS2 = ?*const anyopaque;
    pub const PFN_PRINTING_NOTIFYUNUSEDPORTS2 = ?*const anyopaque;
    pub const PFN_PRINTING_POWEREVENT2 = ?*const anyopaque;
    pub const _CPSUICALLBACK = ?*const anyopaque;
    pub const PFNCOMPROPSHEET = ?*const anyopaque;
    pub const PFNPROPSHEETUI = ?*const anyopaque;
    pub const PFN_DrvGetDriverSetting = ?*const anyopaque;
    pub const PFN_DrvUpgradeRegistrySetting = ?*const anyopaque;
    pub const PFN_DrvUpdateUISetting = ?*const anyopaque;
    pub const OEMCUIPCALLBACK = ?*const anyopaque;
    pub const EMFPLAYPROC = ?*const anyopaque;
    pub const ROUTER_NOTIFY_CALLBACK = ?*const anyopaque;
};
