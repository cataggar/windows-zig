...
pub const aliases = struct {
    ...
    pub const PF_NPAddConnection = ?*const anyopaque;
    pub const PF_NPAddConnection3 = ?*const anyopaque;
    pub const PF_NPAddConnection4 = ?*const anyopaque;
    pub const PF_NPCancelConnection = ?*const anyopaque;
    pub const PF_NPCancelConnection2 = ?*const anyopaque;
    pub const PF_NPGetConnection = ?*const anyopaque;
    pub const PF_NPGetConnection3 = ?*const anyopaque;
    pub const PF_NPGetUniversalName = ?*const anyopaque;
    pub const PF_NPGetConnectionPerformance = ?*const anyopaque;
    pub const PF_NPOpenEnum = ?*const anyopaque;
    pub const PF_NPEnumResource = ?*const anyopaque;
    pub const PF_NPCloseEnum = ?*const anyopaque;
    pub const PF_NPGetCaps = ?*const anyopaque;
    pub const PF_NPGetUser = ?*const anyopaque;
    pub const PF_NPGetPersistentUseOptionsForConnection = ?*const anyopaque;
    pub const PF_NPDeviceMode = ?*const anyopaque;
    pub const PF_NPSearchDialog = ?*const anyopaque;
    pub const PF_NPGetResourceParent = ?*const anyopaque;
    pub const PF_NPGetResourceInformation = ?*const anyopaque;
    pub const PF_NPFormatNetworkName = ?*const anyopaque;
    pub const PF_NPGetPropertyText = ?*const anyopaque;
    pub const PF_NPPropertyDialog = ?*const anyopaque;
    pub const PF_NPGetDirectoryType = ?*const anyopaque;
    pub const PF_NPDirectoryNotify = ?*const anyopaque;
    pub const PF_NPLogonNotify = ?*const anyopaque;
    pub const PF_NPPasswordChangeNotify = ?*const anyopaque;
    pub const PF_AddConnectNotify = ?*const anyopaque;
    pub const PF_CancelConnectNotify = ?*const anyopaque;
    pub const PF_NPFMXGetPermCaps = ?*const anyopaque;
    pub const PF_NPFMXEditPerm = ?*const anyopaque;
    pub const PF_NPFMXGetPermHelp = ?*const anyopaque;
};
