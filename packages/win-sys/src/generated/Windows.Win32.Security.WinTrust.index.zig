...
pub const aliases = struct {
    ...
    pub const PFN_CPD_MEM_ALLOC = ?*const anyopaque;
    pub const PFN_CPD_MEM_FREE = ?*const anyopaque;
    pub const PFN_CPD_ADD_STORE = ?*const anyopaque;
    pub const PFN_CPD_ADD_SGNR = ?*const anyopaque;
    pub const PFN_CPD_ADD_CERT = ?*const anyopaque;
    pub const PFN_CPD_ADD_PRIVDATA = ?*const anyopaque;
    pub const PFN_PROVIDER_INIT_CALL = ?*const anyopaque;
    pub const PFN_PROVIDER_OBJTRUST_CALL = ?*const anyopaque;
    pub const PFN_PROVIDER_SIGTRUST_CALL = ?*const anyopaque;
    pub const PFN_PROVIDER_CERTTRUST_CALL = ?*const anyopaque;
    pub const PFN_PROVIDER_FINALPOLICY_CALL = ?*const anyopaque;
    pub const PFN_PROVIDER_TESTFINALPOLICY_CALL = ?*const anyopaque;
    pub const PFN_PROVIDER_CLEANUP_CALL = ?*const anyopaque;
    pub const PFN_PROVIDER_CERTCHKPOLICY_CALL = ?*const anyopaque;
    pub const PFN_PROVUI_CALL = ?*const anyopaque;
    pub const PFN_ALLOCANDFILLDEFUSAGE = ?*const anyopaque;
    pub const PFN_FREEDEFUSAGE = ?*const anyopaque;
    pub const PFN_WTD_GENERIC_CHAIN_POLICY_CALLBACK = ?*const anyopaque;
};
