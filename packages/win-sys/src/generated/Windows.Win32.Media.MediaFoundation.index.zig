...
pub const aliases = struct {
    ...
    pub const PDXVAHDSW_CreateDevice = ?*const anyopaque;
    pub const PDXVAHDSW_ProposeVideoPrivateFormat = ?*const anyopaque;
    pub const PDXVAHDSW_GetVideoProcessorDeviceCaps = ?*const anyopaque;
    pub const PDXVAHDSW_GetVideoProcessorOutputFormats = ?*const anyopaque;
    pub const PDXVAHDSW_GetVideoProcessorInputFormats = ?*const anyopaque;
    pub const PDXVAHDSW_GetVideoProcessorCaps = ?*const anyopaque;
    pub const PDXVAHDSW_GetVideoProcessorCustomRates = ?*const anyopaque;
    pub const PDXVAHDSW_GetVideoProcessorFilterRange = ?*const anyopaque;
    pub const PDXVAHDSW_DestroyDevice = ?*const anyopaque;
    pub const PDXVAHDSW_CreateVideoProcessor = ?*const anyopaque;
    pub const PDXVAHDSW_SetVideoProcessBltState = ?*const anyopaque;
    pub const PDXVAHDSW_GetVideoProcessBltStatePrivate = ?*const anyopaque;
    pub const PDXVAHDSW_SetVideoProcessStreamState = ?*const anyopaque;
    pub const PDXVAHDSW_GetVideoProcessStreamStatePrivate = ?*const anyopaque;
    pub const PDXVAHDSW_VideoProcessBltHD = ?*const anyopaque;
    pub const PDXVAHDSW_DestroyVideoProcessor = ?*const anyopaque;
    pub const PDXVAHDSW_Plugin = ?*const anyopaque;
    pub const PDXVAHD_CreateDevice = ?*const anyopaque;
    pub const MFPERIODICCALLBACK = ?*const anyopaque;
};
