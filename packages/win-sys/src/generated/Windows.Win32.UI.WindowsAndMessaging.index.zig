...
pub const aliases = struct {
    ...
    pub const DLGPROC = ?*const anyopaque;
    pub const TIMERPROC = ?*const anyopaque;
    pub const WNDENUMPROC = ?*const anyopaque;
    pub const HOOKPROC = ?*const anyopaque;
    pub const SENDASYNCPROC = ?*const anyopaque;
    pub const PROPENUMPROCA = ?*const anyopaque;
    pub const PROPENUMPROCW = ?*const anyopaque;
    pub const PROPENUMPROCEXA = ?*const anyopaque;
    pub const PROPENUMPROCEXW = ?*const anyopaque;
    pub const NAMEENUMPROCA = ?*const anyopaque;
    pub const NAMEENUMPROCW = ?*const anyopaque;
    pub const PREGISTERCLASSNAMEW = ?*const anyopaque;
    pub const MSGBOXCALLBACK = ?*const anyopaque;
};
