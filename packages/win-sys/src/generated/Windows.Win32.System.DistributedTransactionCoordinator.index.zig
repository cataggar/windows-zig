...
pub const aliases = struct {
    ...
    pub const DTC_GET_TRANSACTION_MANAGER = ?*const anyopaque;
    pub const DTC_GET_TRANSACTION_MANAGER_EX_A = ?*const anyopaque;
    pub const DTC_GET_TRANSACTION_MANAGER_EX_W = ?*const anyopaque;
    pub const DTC_INSTALL_CLIENT = ?*const anyopaque;
    pub const XA_OPEN_EPT = ?*const anyopaque;
    pub const XA_CLOSE_EPT = ?*const anyopaque;
    pub const XA_START_EPT = ?*const anyopaque;
    pub const XA_END_EPT = ?*const anyopaque;
    pub const XA_ROLLBACK_EPT = ?*const anyopaque;
    pub const XA_PREPARE_EPT = ?*const anyopaque;
    pub const XA_COMMIT_EPT = ?*const anyopaque;
    pub const XA_RECOVER_EPT = ?*const anyopaque;
    pub const XA_FORGET_EPT = ?*const anyopaque;
    pub const XA_COMPLETE_EPT = ?*const anyopaque;
};
