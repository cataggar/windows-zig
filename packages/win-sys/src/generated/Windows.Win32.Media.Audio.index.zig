...
pub const aliases = struct {
    ...
    pub const LPWAVECALLBACK = ?*const anyopaque;
    pub const LPMIDICALLBACK = ?*const anyopaque;
    pub const PAudioStateMonitorCallback = ?*const anyopaque;
    pub const ACMDRIVERENUMCB = ?*const anyopaque;
    pub const LPACMDRIVERPROC = ?*const anyopaque;
    pub const ACMFORMATTAGENUMCBA = ?*const anyopaque;
    pub const ACMFORMATTAGENUMCBW = ?*const anyopaque;
    pub const ACMFORMATENUMCBA = ?*const anyopaque;
    pub const ACMFORMATENUMCBW = ?*const anyopaque;
    pub const ACMFORMATCHOOSEHOOKPROCA = ?*const anyopaque;
    pub const ACMFORMATCHOOSEHOOKPROCW = ?*const anyopaque;
    pub const ACMFILTERTAGENUMCBA = ?*const anyopaque;
    pub const ACMFILTERTAGENUMCBW = ?*const anyopaque;
    pub const ACMFILTERENUMCBA = ?*const anyopaque;
    pub const ACMFILTERENUMCBW = ?*const anyopaque;
    pub const ACMFILTERCHOOSEHOOKPROCA = ?*const anyopaque;
    pub const ACMFILTERCHOOSEHOOKPROCW = ?*const anyopaque;
};
