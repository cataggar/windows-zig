...
//! `win-time`, `win-threading`, `win-reference`, `winbindgen`, `win-sys`,
//! `win`, `win-targets`), their unit tests, and the `bindings` step that
//! regenerates `win-sys` / `win` sources from the vendored `.winmd`
//! metadata.
//!
