...
fn emitEventHeader(
    ...
    try writer.writeAll("const std = @import(\"std\");\n");
    try writer.writeAll("const schema = @import(\"../schema.zig\");\n");
    try writer.writeAll("const reactor_event_runtime = @import(\"../event_runtime.zig\");\n");
    try writer.writeAll("const win_core = @import(\"win-core\");\n");
...
test "emitAttachEventFromManifest covers the seeded widget events" {
    ...
    try std.testing.expect(std.mem.find(u8, source, ".{ \"Microsoft.UI.Xaml.Controls.TextBox#TextChanged\", 1 },") != null);
