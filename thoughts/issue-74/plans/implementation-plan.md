...
**BLOCKED on #86 as of 2026-07-08** — see the "#86 investigation complete" note above. Do not implement this phase's permanent wiring until #86 has a fix or an explicitly accepted-risk decision, since Phase 1 alone (independent of this phase's resource merge) already reproduces #86's crash for every activated window.
